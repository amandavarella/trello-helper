...
# Retrospective Board IDs - for reset_retro_board script
SOURCE_BOARD_RETRO_ID = ENV['TRELLO_SOURCE_BOARD_RETRO_ID']
DESTINATION_BOARD_RETRO_ID = ENV['TRELLO_DESTINATION_BOARD_RETRO_ID']
